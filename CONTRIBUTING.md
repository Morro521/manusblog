...
- 检查 [Issues](https://github.com/Morro521/manusblog/issues) 中是否已有相同报告
- 如果没有，请创建新的 Issue
...
- 检查 [Issues](https://github.com/Morro521/manusblog/issues) 中是否已有相同建议
...
2. **克隆到本地**
   ```bash
   git clone https://github.com/YOUR_USERNAME/manusblog.git
   cd manusblog
   ```

3. **添加上游仓库**
   ```bash
   git remote add upstream https://github.com/Morro521/manusblog.git
   ```
...
- 使用 [GitHub Discussions](https://github.com/Morro521/manusblog/discussions) 进行一般性讨论
- 使用 [GitHub Issues](https://github.com/Morro521/manusblog/issues) 报告 Bug 或建议功能
...
有任何问题？欢迎在 [GitHub Discussions](https://github.com/Morro521/manusblog/discussions) 中提问！
