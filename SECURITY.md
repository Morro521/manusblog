...
2. **使用 GitHub 的私密安全通知**：
   - 访问 [Security Advisories](https://github.com/Morro521/manusblog/security/advisories)
...
- 使用邮箱验证码验证、bcrypt 密码哈希与 httpOnly JWT Cookie 会话进行身份验证
...
- **GitHub Issues**：[报告非安全问题](https://github.com/Morro521/manusblog/issues)
